    ...
    return (
      <>
        ...
        <div className="bg-paper bg-amber-50/70 min-h-screen">
          ...
          <p>Login is not configured. Set VITE_SUPABASE_URL and VITE_SUPABASE_ANON_KEY in .env</p>
    ...
    <>
      ...
      <div className="bg-paper bg-amber-50/70 min-h-screen">
        ...
        <p className="mt-1 text-sm text-gray-600">
          ...
          <Link to={`/register${redirectTo !== '/' ? `?redirect=${encodeURIComponent(redirectTo)}` : ''}`} className="text-stone-600 hover:text-stone-800 hover:underline">
            Sign up
          </Link>
        </p>
